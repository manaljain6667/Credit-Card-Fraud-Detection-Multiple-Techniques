...
X_under,Y_under = undersample.fit_resample(data_features, data_targets)

np.random.seed(42)
X_train, X_test, Y_train, Y_test = train_test_split(X_under, Y_under,train_size = 0.70, test_size = 0.30, random_state = 1)
